...
<body>
    ...
    <div class="container">
        ...
        <div class="card text-dark">
            ...
            <table align="center">
                <tr>
                    <td colspan="2" style="font-size: 14pt; padding-top: 10px;"><b>ของคุณที่ใช้บริการ...</b></td>
                </tr>

            </table>
            <table align="left">
                <tr>
                    <td colspan="2" style="font-size: 14pt; padding-top: 10px; padding-left: 40px;"><b>ลงชื่อเจ้าของบริษัท </b><u><?php echo $row2['comOwner']; ?></u></td>
                </tr>
            </table>
            <br><br>
        </div>
