                    ...
                    ?>
                        <div class="card" style="width: 80%;">
                            ...
                            <table class="table-borderless" cellpadding="20px">
                                ...
                                <tr>
                                    <td style="padding-left: 20px;"><a class="btn btn-warning" href="../managerData/edit_company.php?id=<?php echo $row['comID'];?>" onclick="return confirm('คุณต้องการแกไขข้อมูล <?php echo $row['comName']; ?> ?')"><i class="fa fa-wrench" aria-hidden="true"></i></a></td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
