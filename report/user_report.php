                                ...
                                <table class="table-borderless" id="example">
                                    <thead style="text-align: center;">
                                        <tr>
                                            ...
                                            <th style="width: 20%;"><b>รหัสพนักงาน</b></th>
                                            <th style="width: 25%;"><b>ชื่อ นาสกุล</b></th>
                                            <th style="width: 10%;"><b>ตำแหน่ง</b></th>
                                            <th style="width: 25%;"><b>E-mail</b></th>
                                            <th style="width: 15%;"><b>เบอร์โทร</b></th>
                                            <th style="width: 10%;"><b>เพศ</b></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 20%;"><?php echo $row['usrID']; ?></td>
                                                <td style="width: 25%;"><?php echo $row['usrName']; ?></td>
                                                <td style="width: 10%;"><?php echo $row['level']; ?></td>
                                                <td style="width: 25%;"><?php echo $row['email']; ?></td>
                                                <td style="width: 15%;"><?php echo $row['numPhone']; ?></td>
